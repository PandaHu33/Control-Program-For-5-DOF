...
class CanonicalGoalTests(unittest.TestCase):
    ...
    def test_browser_and_wa100_sources_contain_canonical_contract_hooks(self):
        ...
        self.assertIn("applyPositionDelta(axisY * step, -axisX * step, -zAxis * step)", html)
        self.assertIn('"ui-gamepad-mapping-v3-pico-axes"', html)
        self.assertIn('"ui-keyboard-mapping-v2-pico-axes"', html)
