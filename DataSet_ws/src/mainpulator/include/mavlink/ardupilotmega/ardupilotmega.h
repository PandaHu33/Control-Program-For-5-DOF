...
#define MAVLINK_ARDUPILOTMEGA_XML_HASH -1154885873868623766
...
#include "./mavlink_msg_depth_target.h"
#include "./mavlink_msg_qgc2manipulator.h"
#include "./mavlink_msg_rov_acoef.h"
#include "./mavlink_msg_manipulator2qgc.h"
