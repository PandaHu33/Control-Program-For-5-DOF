...
#ifdef MAVLINK_HAVE_GET_MESSAGE_INFO
    MAVLINK_ASSERT(mavlink_get_message_info_by_name("CSDN_TEST") != NULL);
    MAVLINK_ASSERT(mavlink_get_message_info_by_id(MAVLINK_MSG_ID_CSDN_TEST) != NULL);
#endif
}

static void mavlink_test_depth_target(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
#ifdef MAVLINK_STATUS_FLAG_OUT_MAVLINK1
    mavlink_status_t *status = mavlink_get_channel_status(MAVLINK_COMM_0);
        if ((status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) && MAVLINK_MSG_ID_depth_target >= 256) {
            return;
        }
#endif
    mavlink_message_t msg;
        uint8_t buffer[MAVLINK_MAX_PACKET_LEN];
        uint16_t i;
    mavlink_depth_target_t packet_in = {
        17.0
    };
    mavlink_depth_target_t packet1, packet2;
        memset(&packet1, 0, sizeof(packet1));
        packet1.byte1 = packet_in.byte1;
        ...
        if (status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) {
           // cope with extensions
           memset(MAVLINK_MSG_ID_depth_target_MIN_LEN + (char *)&packet1, 0, sizeof(packet1)-MAVLINK_MSG_ID_depth_target_MIN_LEN);
        }
#endif
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_depth_target_encode(system_id, component_id, &msg, &packet1);
    mavlink_msg_depth_target_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_depth_target_pack(system_id, component_id, &msg , packet1.byte1 );
    mavlink_msg_depth_target_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_depth_target_pack_chan(system_id, component_id, MAVLINK_COMM_0, &msg , packet1.byte1 );
    mavlink_msg_depth_target_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
    ...
    mavlink_msg_depth_target_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
        
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_depth_target_send(MAVLINK_COMM_1 , packet1.byte1 );
    mavlink_msg_depth_target_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

#ifdef MAVLINK_HAVE_GET_MESSAGE_INFO
    MAVLINK_ASSERT(mavlink_get_message_info_by_name("depth_target") != NULL);
    MAVLINK_ASSERT(mavlink_get_message_info_by_id(MAVLINK_MSG_ID_depth_target) != NULL);
#endif
}

static void mavlink_test_qgc2manipulator(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
#ifdef MAVLINK_STATUS_FLAG_OUT_MAVLINK1
    mavlink_status_t *status = mavlink_get_channel_status(MAVLINK_COMM_0);
        if ((status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) && MAVLINK_MSG_ID_QGC2MANIPULATOR >= 256) {
            return;
        }
#endif
    mavlink_message_t msg;
        uint8_t buffer[MAVLINK_MAX_PACKET_LEN];
        uint16_t i;
    mavlink_qgc2manipulator_t packet_in = {
        17.0,45.0,73.0,101.0,129.0,157.0,185.0,213.0,241.0,269.0,297.0,325.0,353.0,381.0,409.0,437.0,465.0,493.0,521.0,549.0,577.0,605.0,633.0,661.0,689.0,717.0,745.0,773.0,801.0,829.0
    };
    mavlink_qgc2manipulator_t packet1, packet2;
        memset(&packet1, 0, sizeof(packet1));
        packet1.angle1 = packet_in.angle1;
        packet1.angle2 = packet_in.angle2;
        packet1.angle3 = packet_in.angle3;
        packet1.angle4 = packet_in.angle4;
        packet1.angle5 = packet_in.angle5;
        packet1.angular_vel1 = packet_in.angular_vel1;
        packet1.angular_vel2 = packet_in.angular_vel2;
        packet1.angular_vel3 = packet_in.angular_vel3;
        packet1.angular_vel4 = packet_in.angular_vel4;
        packet1.angular_vel5 = packet_in.angular_vel5;
        packet1.pos_x = packet_in.pos_x;
        packet1.pos_y = packet_in.pos_y;
        packet1.pos_z = packet_in.pos_z;
        packet1.button = packet_in.button;
        packet1.keyboard1 = packet_in.keyboard1;
        packet1.keyboard2 = packet_in.keyboard2;
        packet1.keyboard3 = packet_in.keyboard3;
        packet1.keyboard4 = packet_in.keyboard4;
        packet1.keyboard5 = packet_in.keyboard5;
        packet1.keyboard6 = packet_in.keyboard6;
        packet1.keyboard7 = packet_in.keyboard7;
        packet1.keyboard8 = packet_in.keyboard8;
        packet1.keyboard9 = packet_in.keyboard9;
        packet1.keyboard10 = packet_in.keyboard10;
        packet1.status = packet_in.status;
        packet1.stop_sign = packet_in.stop_sign;
        ...
        if (status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) {
           // cope with extensions
           memset(MAVLINK_MSG_ID_QGC2MANIPULATOR_MIN_LEN + (char *)&packet1, 0, sizeof(packet1)-MAVLINK_MSG_ID_QGC2MANIPULATOR_MIN_LEN);
        }
#endif
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_qgc2manipulator_encode(system_id, component_id, &msg, &packet1);
    mavlink_msg_qgc2manipulator_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_qgc2manipulator_pack(system_id, component_id, &msg , packet1.angle1 , packet1.angle2 , packet1.angle3 , packet1.angle4 , packet1.angle5 , packet1.angular_vel1 , packet1.angular_vel2 , packet1.angular_vel3 , packet1.angular_vel4 , packet1.angular_vel5 , packet1.pos_x , packet1.pos_y , packet1.pos_z , packet1.button , packet1.keyboard1 , packet1.keyboard2 , packet1.keyboard3 , packet1.keyboard4 , packet1.keyboard5 , packet1.keyboard6 , packet1.keyboard7 , packet1.keyboard8 , packet1.keyboard9 , packet1.keyboard10 , packet1.status , packet1.stop_sign , packet1.reserved1 , packet1.reserved2 , packet1.reserved3 , packet1.reserved4 );
    mavlink_msg_qgc2manipulator_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_qgc2manipulator_pack_chan(system_id, component_id, MAVLINK_COMM_0, &msg , packet1.angle1 , packet1.angle2 , packet1.angle3 , packet1.angle4 , packet1.angle5 , packet1.angular_vel1 , packet1.angular_vel2 , packet1.angular_vel3 , packet1.angular_vel4 , packet1.angular_vel5 , packet1.pos_x , packet1.pos_y , packet1.pos_z , packet1.button , packet1.keyboard1 , packet1.keyboard2 , packet1.keyboard3 , packet1.keyboard4 , packet1.keyboard5 , packet1.keyboard6 , packet1.keyboard7 , packet1.keyboard8 , packet1.keyboard9 , packet1.keyboard10 , packet1.status , packet1.stop_sign , packet1.reserved1 , packet1.reserved2 , packet1.reserved3 , packet1.reserved4 );
    mavlink_msg_qgc2manipulator_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
    ...
    mavlink_msg_qgc2manipulator_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
        
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_qgc2manipulator_send(MAVLINK_COMM_1 , packet1.angle1 , packet1.angle2 , packet1.angle3 , packet1.angle4 , packet1.angle5 , packet1.angular_vel1 , packet1.angular_vel2 , packet1.angular_vel3 , packet1.angular_vel4 , packet1.angular_vel5 , packet1.pos_x , packet1.pos_y , packet1.pos_z , packet1.button , packet1.keyboard1 , packet1.keyboard2 , packet1.keyboard3 , packet1.keyboard4 , packet1.keyboard5 , packet1.keyboard6 , packet1.keyboard7 , packet1.keyboard8 , packet1.keyboard9 , packet1.keyboard10 , packet1.status , packet1.stop_sign , packet1.reserved1 , packet1.reserved2 , packet1.reserved3 , packet1.reserved4 );
    mavlink_msg_qgc2manipulator_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

#ifdef MAVLINK_HAVE_GET_MESSAGE_INFO
    MAVLINK_ASSERT(mavlink_get_message_info_by_name("QGC2MANIPULATOR") != NULL);
    MAVLINK_ASSERT(mavlink_get_message_info_by_id(MAVLINK_MSG_ID_QGC2MANIPULATOR) != NULL);
#endif
}

static void mavlink_test_rov_acoef(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
#ifdef MAVLINK_STATUS_FLAG_OUT_MAVLINK1
    mavlink_status_t *status = mavlink_get_channel_status(MAVLINK_COMM_0);
        if ((status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) && MAVLINK_MSG_ID_ROV_ACOEF >= 256) {
            return;
        }
#endif
    mavlink_message_t msg;
        uint8_t buffer[MAVLINK_MAX_PACKET_LEN];
        uint16_t i;
    mavlink_rov_acoef_t packet_in = {
        963497464,45.0,73.0,101.0,129.0,157.0,185.0,213.0,241.0,269.0,297.0,325.0,353.0,963500168,963500376,185,252,"KLMNOPQRSTUVWXYZABCDEFGHIJKLMNOPQRSTUVW",183,250,61
    };
    mavlink_rov_acoef_t packet1, packet2;
        memset(&packet1, 0, sizeof(packet1));
        packet1.CommuFreq = packet_in.CommuFreq;
        packet1.MaxSAng = packet_in.MaxSAng;
        packet1.MinSAng = packet_in.MinSAng;
        packet1.MaxTSpd = packet_in.MaxTSpd;
        packet1.DepthPID = packet_in.DepthPID;
        packet1.YawPID = packet_in.YawPID;
        packet1.PosCtrl = packet_in.PosCtrl;
        packet1.AvoiCtrl = packet_in.AvoiCtrl;
        packet1.alternate_rov_acoef_float_1 = packet_in.alternate_rov_acoef_float_1;
        packet1.alternate_rov_acoef_float_2 = packet_in.alternate_rov_acoef_float_2;
        packet1.alternate_rov_acoef_float_3 = packet_in.alternate_rov_acoef_float_3;
        packet1.alternate_rov_acoef_float_4 = packet_in.alternate_rov_acoef_float_4;
        packet1.alternate_rov_acoef_float_5 = packet_in.alternate_rov_acoef_float_5;
        packet1.alternate_rov_acoef_int_4 = packet_in.alternate_rov_acoef_int_4;
        packet1.alternate_rov_acoef_int_5 = packet_in.alternate_rov_acoef_int_5;
        packet1.MovCtrl = packet_in.MovCtrl;
        packet1.ServoCtrl = packet_in.ServoCtrl;
        packet1.alternate_rov_acoef_int_1 = packet_in.alternate_rov_acoef_int_1;
        packet1.alternate_rov_acoef_int_2 = packet_in.alternate_rov_acoef_int_2;
        packet1.alternate_rov_acoef_int_3 = packet_in.alternate_rov_acoef_int_3;
        
        mav_array_memcpy(packet1.MCtrlIP, packet_in.MCtrlIP, sizeof(char)*40);
        
#ifdef MAVLINK_STATUS_FLAG_OUT_MAVLINK1
        if (status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) {
           // cope with extensions
           memset(MAVLINK_MSG_ID_ROV_ACOEF_MIN_LEN + (char *)&packet1, 0, sizeof(packet1)-MAVLINK_MSG_ID_ROV_ACOEF_MIN_LEN);
        }
#endif
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_rov_acoef_encode(system_id, component_id, &msg, &packet1);
    mavlink_msg_rov_acoef_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_rov_acoef_pack(system_id, component_id, &msg , packet1.MovCtrl , packet1.ServoCtrl , packet1.CommuFreq , packet1.MaxSAng , packet1.MinSAng , packet1.MCtrlIP , packet1.MaxTSpd , packet1.DepthPID , packet1.YawPID , packet1.PosCtrl , packet1.AvoiCtrl , packet1.alternate_rov_acoef_float_1 , packet1.alternate_rov_acoef_float_2 , packet1.alternate_rov_acoef_float_3 , packet1.alternate_rov_acoef_float_4 , packet1.alternate_rov_acoef_float_5 , packet1.alternate_rov_acoef_int_1 , packet1.alternate_rov_acoef_int_2 , packet1.alternate_rov_acoef_int_3 , packet1.alternate_rov_acoef_int_4 , packet1.alternate_rov_acoef_int_5 );
    mavlink_msg_rov_acoef_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_rov_acoef_pack_chan(system_id, component_id, MAVLINK_COMM_0, &msg , packet1.MovCtrl , packet1.ServoCtrl , packet1.CommuFreq , packet1.MaxSAng , packet1.MinSAng , packet1.MCtrlIP , packet1.MaxTSpd , packet1.DepthPID , packet1.YawPID , packet1.PosCtrl , packet1.AvoiCtrl , packet1.alternate_rov_acoef_float_1 , packet1.alternate_rov_acoef_float_2 , packet1.alternate_rov_acoef_float_3 , packet1.alternate_rov_acoef_float_4 , packet1.alternate_rov_acoef_float_5 , packet1.alternate_rov_acoef_int_1 , packet1.alternate_rov_acoef_int_2 , packet1.alternate_rov_acoef_int_3 , packet1.alternate_rov_acoef_int_4 , packet1.alternate_rov_acoef_int_5 );
    mavlink_msg_rov_acoef_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
    ...
    mavlink_msg_rov_acoef_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
        
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_rov_acoef_send(MAVLINK_COMM_1 , packet1.MovCtrl , packet1.ServoCtrl , packet1.CommuFreq , packet1.MaxSAng , packet1.MinSAng , packet1.MCtrlIP , packet1.MaxTSpd , packet1.DepthPID , packet1.YawPID , packet1.PosCtrl , packet1.AvoiCtrl , packet1.alternate_rov_acoef_float_1 , packet1.alternate_rov_acoef_float_2 , packet1.alternate_rov_acoef_float_3 , packet1.alternate_rov_acoef_float_4 , packet1.alternate_rov_acoef_float_5 , packet1.alternate_rov_acoef_int_1 , packet1.alternate_rov_acoef_int_2 , packet1.alternate_rov_acoef_int_3 , packet1.alternate_rov_acoef_int_4 , packet1.alternate_rov_acoef_int_5 );
    mavlink_msg_rov_acoef_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

#ifdef MAVLINK_HAVE_GET_MESSAGE_INFO
    MAVLINK_ASSERT(mavlink_get_message_info_by_name("ROV_ACOEF") != NULL);
    MAVLINK_ASSERT(mavlink_get_message_info_by_id(MAVLINK_MSG_ID_ROV_ACOEF) != NULL);
#endif
}

static void mavlink_test_manipulator2qgc(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
#ifdef MAVLINK_STATUS_FLAG_OUT_MAVLINK1
    mavlink_status_t *status = mavlink_get_channel_status(MAVLINK_COMM_0);
        if ((status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) && MAVLINK_MSG_ID_MANIPULATOR2QGC >= 256) {
            return;
        }
#endif
    mavlink_message_t msg;
        uint8_t buffer[MAVLINK_MAX_PACKET_LEN];
        uint16_t i;
    mavlink_manipulator2qgc_t packet_in = {
        17.0,45.0,73.0,101.0,129.0,157.0,185.0,213.0,241.0,269.0,297.0,325.0,353.0,381.0,409.0,437.0,465.0,493.0,521.0,549.0,577.0,605.0,633.0,661.0,689.0,717.0,745.0,773.0,801.0,829.0
    };
    mavlink_manipulator2qgc_t packet1, packet2;
        memset(&packet1, 0, sizeof(packet1));
        packet1.angle1 = packet_in.angle1;
        packet1.angle2 = packet_in.angle2;
        packet1.angle3 = packet_in.angle3;
        ...
        if (status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) {
           // cope with extensions
           memset(MAVLINK_MSG_ID_MANIPULATOR2QGC_MIN_LEN + (char *)&packet1, 0, sizeof(packet1)-MAVLINK_MSG_ID_MANIPULATOR2QGC_MIN_LEN);
        }
#endif
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_manipulator2qgc_encode(system_id, component_id, &msg, &packet1);
    mavlink_msg_manipulator2qgc_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_manipulator2qgc_pack(system_id, component_id, &msg , packet1.angle1 , packet1.angle2 , packet1.angle3 , packet1.angle4 , packet1.angle5 , packet1.angular_vel1 , packet1.angular_vel2 , packet1.angular_vel3 , packet1.angular_vel4 , packet1.angular_vel5 , packet1.pos_x , packet1.pos_y , packet1.pos_z , packet1.button , packet1.keyboard1 , packet1.keyboard2 , packet1.keyboard3 , packet1.keyboard4 , packet1.keyboard5 , packet1.keyboard6 , packet1.keyboard7 , packet1.keyboard8 , packet1.keyboard9 , packet1.keyboard10 , packet1.status , packet1.stop_sign , packet1.reserved1 , packet1.reserved2 , packet1.reserved3 , packet1.reserved4 );
    mavlink_msg_manipulator2qgc_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_manipulator2qgc_pack_chan(system_id, component_id, MAVLINK_COMM_0, &msg , packet1.angle1 , packet1.angle2 , packet1.angle3 , packet1.angle4 , packet1.angle5 , packet1.angular_vel1 , packet1.angular_vel2 , packet1.angular_vel3 , packet1.angular_vel4 , packet1.angular_vel5 , packet1.pos_x , packet1.pos_y , packet1.pos_z , packet1.button , packet1.keyboard1 , packet1.keyboard2 , packet1.keyboard3 , packet1.keyboard4 , packet1.keyboard5 , packet1.keyboard6 , packet1.keyboard7 , packet1.keyboard8 , packet1.keyboard9 , packet1.keyboard10 , packet1.status , packet1.stop_sign , packet1.reserved1 , packet1.reserved2 , packet1.reserved3 , packet1.reserved4 );
    mavlink_msg_manipulator2qgc_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
    ...
    mavlink_msg_manipulator2qgc_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
        
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_manipulator2qgc_send(MAVLINK_COMM_1 , packet1.angle1 , packet1.angle2 , packet1.angle3 , packet1.angle4 , packet1.angle5 , packet1.angular_vel1 , packet1.angular_vel2 , packet1.angular_vel3 , packet1.angular_vel4 , packet1.angular_vel5 , packet1.pos_x , packet1.pos_y , packet1.pos_z , packet1.button , packet1.keyboard1 , packet1.keyboard2 , packet1.keyboard3 , packet1.keyboard4 , packet1.keyboard5 , packet1.keyboard6 , packet1.keyboard7 , packet1.keyboard8 , packet1.keyboard9 , packet1.keyboard10 , packet1.status , packet1.stop_sign , packet1.reserved1 , packet1.reserved2 , packet1.reserved3 , packet1.reserved4 );
    mavlink_msg_manipulator2qgc_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

#ifdef MAVLINK_HAVE_GET_MESSAGE_INFO
    MAVLINK_ASSERT(mavlink_get_message_info_by_name("MANIPULATOR2QGC") != NULL);
    MAVLINK_ASSERT(mavlink_get_message_info_by_id(MAVLINK_MSG_ID_MANIPULATOR2QGC) != NULL);
#endif
}
...
static void mavlink_test_ardupilotmega(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
    ...
    mavlink_test_depth_target(system_id, component_id, last_msg);
    mavlink_test_qgc2manipulator(system_id, component_id, last_msg);
    mavlink_test_rov_acoef(system_id, component_id, last_msg);
    mavlink_test_manipulator2qgc(system_id, component_id, last_msg);
