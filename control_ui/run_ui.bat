...
ssh -o BatchMode=yes -o ConnectTimeout=5 mumu@192.168.1.35 "echo ok" >nul 2>nul

if errorlevel 1 (
    echo [WARN] SSH passwordless login failed. Running first-connect setup...
    powershell -ExecutionPolicy Bypass -File "%~dp0setup_ssh_first_connect.ps1" -User mumu -HostIp 192.168.1.35
